...
public class PH_Member {
    ...
    public void Security() throws InterruptedException{
        ...
        //Select Branch
        WebElement Branch = driver.findElement(By.xpath("//select[@id='ctl00_ContentPlaceHolder1_ddlBranchId']/option[@value='165']"));
        Branch.click();
        Thread.sleep(1000);
        //Select Loan Officer
        WebElement LoanOfficer = driver.findElement(By.xpath("//select[@id='ctl00_ContentPlaceHolder1_ddlP_LoanOfficerId']/option[@value='30679']"));
        LoanOfficer.click();
        Thread.sleep(1000);
        ...
        //Input First Name
        driver.findElement(By.xpath("//input[@id='ctl00_ContentPlaceHolder1_txtFirstName']")).sendKeys("Akash");
        Thread.sleep(1000);

        //Input First Name
        driver.findElement(By.xpath("//input[@id='ctl00_ContentPlaceHolder1_txtFirstName']")).sendKeys("Ahmed Release Forty Four ");
        Thread.sleep(1000);
